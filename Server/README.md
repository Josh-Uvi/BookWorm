...
**faster-whisper** (STT) → **any OpenAI-compatible LLM** (Ollama by default) → **edge-tts/Piper**
(TTS) — and speaks encouraging help back to the child. No cloud SDKs, no vendor credentials.
